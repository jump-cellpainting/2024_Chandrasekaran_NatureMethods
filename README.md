...
See this [blog post](https://carpenter-singh-lab.broadinstitute.org/blog/help-interpreting-image-based-profiles) for sample Cell Painting images and the meaning of (CellProfiler-derived) Cell Painting features. 
